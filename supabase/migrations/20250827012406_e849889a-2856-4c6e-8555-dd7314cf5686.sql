...
-- Create policies for public access to legislators and bills (no auth needed for this data)
...
-- Create policies for subscriber data (simplified for MVP - we'll handle user management in the app)
CREATE POLICY "Allow all subscriber operations" 
ON public.subscribers 
FOR ALL 
USING (true)
WITH CHECK (true);

CREATE POLICY "Allow all subscriber district operations" 
ON public.subscriber_districts 
FOR ALL 
USING (true)
WITH CHECK (true);

CREATE POLICY "Allow all notification preference operations" 
ON public.notification_preferences 
FOR ALL 
USING (true)
WITH CHECK (true);

CREATE POLICY "Allow all dedup operations" 
